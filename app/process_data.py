...
def process_coins():
    coins_db = SqliteDict('/home/phennaux115/Documents/Python-Flask/coins.db', autocommit=True)
...
def set_coins_json():
    coins = SqliteDict('/home/phennaux115/Documents/Python-Flask/coins.db', autocommit=True)
    coins["coin_data"] = get_data("/v1/ticker/?limit=100")
    coins.close()
